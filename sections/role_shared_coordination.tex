...
$\operatorname{pred}(n)\triangleq\{j\mid (j,n)\in\mathcal{L}\}$ denotes the set
of predecessor nodes of $n$.
...
For a task-update event, the externally updated instruction directly replaces
the current $\gamma$ before role-specific semantic updates. The intermediate graph is used
