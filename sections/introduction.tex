...
\begin{figure}[t]
    ...
    execution; \textbf{Bottom-middle:} online task update; \textbf{Bottom-right:}
...
We propose RoSC, a role-shared semantic coordination framework with
