...
motion to remain local. After execution, $o_t'$ denotes the newly obtained
observation. It refreshes $\mathcal{F}$ through
$\mathcal{F}\gets\rho_A(o_t')$ without semantic
