...
\begin{figure}[!t]
  ...
  Fig.~\ref{fig:hardware_gantt} (top row) and the external disturbance in the
  right panel (bottom row). The three role outputs jointly compose the
  corresponding update of the shared semantic state $S_{\mathrm{sem}}$.}
...
$G$ while retaining unaffected work. In the bottom row, the object relocation
