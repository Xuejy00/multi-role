...
execution failure).
For $\texttt{C2-E3}$, execution failure is induced by adding obstacles around
the target object, such as stacking objects that block manipulation; for
$\texttt{C4-E3}$, it is induced by substantially increasing conveyor speed,
creating a dynamic physical disturbance.
...
the static, task-update, and disturbance conditions, with 30/30 for
$\texttt{C2-E3}$ and 27/30 for $\texttt{C4-E3}$; SCR was 100\% except for 88.9\% in
...
and disturbance cases, with 30/30 for $\texttt{C2-E3}$ and 27/30 for
$\texttt{C4-E3}$, while every baseline
