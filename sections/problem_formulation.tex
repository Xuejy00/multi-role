...
The next command set is generated online from the task, heterogeneous
capabilities, visual history, semantic event history, and previously issued
command sets:
\begin{equation}
 \mathbf{c}_m=
 \Pi\!\left(
...
observed by that time.  The ordering of the arguments preserves the information
flow from task specification and embodiment capabilities to observations,
events, and prior command sets.
